      ...
      <div className="header">
        ...
        <div className="nav-items">
          <ul>
            ...
            <li>Join TMDB</li>
            <li>
              <img className="search-icon" src="https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-28-search-blue-177462d06db81ff2a02aa022c1c0be5ba4200d7bd3f51091ed9298980e3a26a1.svg" alt="search-btn"/>
            </li>
